...
async function setVideoSource() {
    try {
        ...
        // Get the video source path for "videoLoebGivOp" from the JSON data
        const videoSrc = data[6].VideoLoebGivOp;  // Access the seventh object for "videoLoebGivOp" video
